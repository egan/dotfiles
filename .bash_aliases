...
alias mutt='exec tmux source-file $HOME/.tmux/mutt.conf'
...
alias hastings='exec tmux source-file $HOME/.tmux/hastings.conf'
...
alias mercury='sudo mount /dev/disk/by-uuid/805D-07BD /media/Mercury'
