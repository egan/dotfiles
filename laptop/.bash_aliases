...
alias sagenb='sage -c "notebook(automatic_login=True)" &> /dev/null &'
...
alias imsput='rsync -avz --exclude-from=$HOME/.rsync/exclude -e "ssh -p 1729 -l EMcComb" $HOME/docs/ims/ 10.1.1.128:'
